...
public class ResponseSpecBuilder {
     ...
     */
    private static final ConcurrentHashMap<String, ResponseSpecData> responseSpecs;
     ...
     */
    private static Map<String, ResponseSpecData> buildResponseSpecsFromResources() {
